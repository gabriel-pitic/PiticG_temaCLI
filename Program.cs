...
namespace PiticG_temaCLI
{
    class SimpleWindow3D : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            Vector2 pos = new Vector2(mouse.X, mouse.Y); //ia pozitia mouse-ului curent
        ...
        {
            base.OnMouseMove(e);
            angle += rotation_speed * (float)0.003; //implementare demonstrativă
        }
